...
//public class PrincipalGui extends JFrame {
	...
	public PrincipalGui() {
			...
			txtNombre.setBounds(176, 5, 86, 20);
			contentPane.add(txtNombre);
			txtNombre.setColumns(10);
			
			JLabel lblNewLabel_1 = new JLabel("Apellido:");
			lblNewLabel_1.setBounds(77, 33, 47, 14);
			contentPane.add(lblNewLabel_1);
			
			txtApellido = new JTextField();
			txtApellido.setBounds(176, 30, 86, 20);
			txtApellido.setText("");
			contentPane.add(txtApellido);
			txtApellido.setColumns(10);
			
			JLabel lblNewLabel_2 = new JLabel("Teléfono:");
			lblNewLabel_2.setBounds(75, 58, 49, 14);
			contentPane.add(lblNewLabel_2);
			
			txtTelefono = new JTextField();
			txtTelefono.setBounds(176, 55, 86, 20);
			contentPane.add(txtTelefono);
			txtTelefono.setColumns(10);
			
			JLabel lblNewLabel_3 = new JLabel("Cédula:");
			lblNewLabel_3.setBounds(80, 83, 41, 14);
			contentPane.add(lblNewLabel_3);
			
			txtCedula = new JTextField();
			txtCedula.setBounds(176, 80, 86, 20);
